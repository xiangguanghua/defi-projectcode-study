...
contract ParaSwapRepayAdapter is BaseParaSwapBuyAdapter, ReentrancyGuard {
    ...
    constructor(IPoolAddressesProvider addressesProvider, IParaSwapAugustusRegistry augustusRegistry, address owner)
    ...
    function swapAndRepay(
        ...
        uint256 amountSold = _buyOnParaSwap(
            buyAllBalanceOffset, paraswapData, collateralAsset, debtAsset, collateralAmount, debtRepayAmount
        );
