...
library CalldataLogic {
     ...
     */
    function decodeSupplyWithPermitParams(mapping(uint256 => address) storage reservesList, bytes32 args)
        internal
        view
        returns (address, uint256, uint16, uint256, uint8)
    {
        uint256 deadline;
        uint8 permitV;
    ...
    function decodeBorrowParams(mapping(uint256 => address) storage reservesList, bytes32 args)
        internal
        view
        returns (address, uint256, uint256, uint16)
    {
        uint16 assetId;
        uint256 amount;
    ...
    function decodeRepayWithPermitParams(mapping(uint256 => address) storage reservesList, bytes32 args)
        internal
        view
        returns (address, uint256, uint256, uint256, uint8)
    {
        uint256 deadline;
        uint8 permitV;
     ...
     */
    function decodeSwapBorrowRateModeParams(mapping(uint256 => address) storage reservesList, bytes32 args)
        internal
        view
        returns (address, uint256)
    {
     ...
     */
    function decodeRebalanceStableBorrowRateParams(mapping(uint256 => address) storage reservesList, bytes32 args)
        internal
        view
     ...
     */
    function decodeSetUserUseReserveAsCollateralParams(mapping(uint256 => address) storage reservesList, bytes32 args)
        internal
        view
     ...
     */
    function decodeLiquidationCallParams(mapping(uint256 => address) storage reservesList, bytes32 args1, bytes32 args2)
        internal
        view
        returns (address, address, address, uint256, bool)
    {
